...
class Modelo_Usuario_Trabajo{
				...
				$consulta = "SELECT 
							* 
							...
							AND 
								usuario.id_usuario = '$this->fk_usuario' 
							AND 
								usuario_trabajo.vinculo = '$this->vinculo'";
	...
	public function consultar_vinculo(){
		try
			{	
				$consulta = "SELECT 
							* 
	...
	public function eliminar_relacion(){
		try
			{	
				$consulta = "DELETE FROM usuario_trabajo WHERE fk_usuario = '$this->fk_usuario' and vinculo = '$this->vinculo'";
		...
		try
			{	
				$consulta = "SELECT 
							* 
							FROM 
								usuario , usuario_trabajo, trabajo, usuario_departamento , departamento , categoria 
							WHERE 
								usuario_trabajo.fk_usuario = usuario.id_usuario 
							AND 
								usuario_trabajo.fk_trabajo = trabajo.id_trabajo 
