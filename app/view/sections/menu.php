                ...
                <?php foreach ($_SESSION['modulos'] as $modulo): 
                        ...
                        switch ($modulo->modulo_nombre) {
                            ...
                            case 'gestionar trabajos':
                                echo '<li><a href="?controller=front&action=trabajos"><span class="glyphicon glyphicon-th-list"></span> '.$modulo->modulo_nombre.'</a></li>';
                                break;
                            ...
                            case 'sistema y seguridad':
                                ...
                                <div class="submenu">
                                    ...
                                    <a href="?controller=front&action=fases">Gestionar Fases</a>
