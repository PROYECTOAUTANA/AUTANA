                    ...
                    <div class="help-block with-errors"></div>
                              ...
                              <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-3 form-group">
                                    <a class="btn btn-default btn-block" href="?controller=usuario&action=reestablecer_clave_a_terceros&id_usuario=<?php echo $datos_usuario->id_usuario; ?>&correo=<?php echo $datos_usuario->usuario_correo; ?>">  Reestablecer contraseña</a>
                                </div>
                                <div class="col-sm-3 form-group">
                    ...
                    <div class="modal-dialog">
                      ...
                      <!--CUERPO O BODY DE LA VENTANA-->
                        <div class="modal-body col-sm-12">
                          ...
                          <form class="form-group" action="?controller=usuario&action=cambio_de_departamento" method="post" data-toggle="validator">
                          <input type="hidden" name="id_usuario" value="<?php echo $datos_usuario->id_usuario; ?>">
                            <div class="col-sm-12 form-group">
                              <select class="form-control" name="departamento" data-error="seleccione un valor." required>
                    ...
                    <div class="modal-dialog">
                      ...
                      <!--CUERPO O BODY DE LA VENTANA-->
                        <div class="modal-body col-sm-12">
                          ...
                          <form class="form-group" action="?controller=usuario&action=cambio_de_categoria" method="post" data-toggle="validator">
                          <input type="hidden" name="id_usuario" value="<?php echo $datos_usuario->id_usuario; ?>">
                            <div class="col-sm-12 form-group">
                              <select class="form-control" name="categoria" data-error="seleccione un valor." required>
                    ...
                    <div class="modal-dialog">
                      ...
                      <!--CUERPO O BODY DE LA VENTANA-->
                        <div class="modal-body col-sm-12">
                          ...
                          <form class="form-group" action="?controller=usuario&action=cambio_de_rol" method="post" data-toggle="validator">
                          <input type="hidden" name="id_usuario" value="<?php echo $datos_usuario->id_usuario; ?>">
                            <div class="col-sm-12 form-group">
                              <select class="form-control" name="rol" data-error="seleccione un valor." required>
