                      ...
                      <!--CUERPO O BODY DE LA VENTANA-->
                        ...
                        <div class="help-block with-errors"></div>
                         ...
                         <div class="form-group col-sm-4">
                          ...
                          <select class="form-control" size="1" name="sexo" id="sexo" data-error="seleccione un valor." required>
                        ...
                        <div class="form-group col-sm-4">
                          <label for="telefono">Teléfono:</label>
                            <input name="telefono" onkeypress="return controltag(event)" class="form-control"­ type="tel" data-minlength="11" data-error="El número debe ser mayor a 10 digitos" placeholder="Escriba­..." required>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group col-sm-4">
                          <label for="inputEmail">Correo:</label>
                          <input type="email" class="form-control" id="correo" name="correo" data-error="Escriba un correo electronico" placeholder="Email (Opcional)" required>
                          <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group col-sm-12">
                          <label for="direccion">Dirección:</label>
                          <textarea  name="direccion" class="form-control" rows="3" data-error="Escriba una direccion" required /></textarea>
                          <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group col-sm-4">
                          <label for="rol">Rol de Usuario:</label>
                          <select name="rol" id="rol" class="form-control" data-error="Seleccione un valor" required>
                        ...
                        <div class="form-group col-sm-4">
                          ...
                          <select name="departamento" id="departamento" class="form-control" data-error="Seleccione un valor" required>
                        ...
                        <div class="form-group col-sm-4">
                          ...
                          <select name="categoria_actual" id="categoria_actual" class="form-control" data-error="Seleccione un valor" required>
                            <option value=''>selecciona</option>
                       ...
                       <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-6">
                          ...
                          <input type="password" class="form-control" name="clave" data-match="#inputPassword" data-match-error="las contraseñas no coinciden" placeholder="Confirm" required>
                        <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group col-sm-12">
