                                                        ...
                                                        <tbody>
                                                          ...
                                                          ?>
                                                            <tr>
                                                             ...
                                                             <?php if ($id_rol == 1): ?>
                                                                <td>
                                                                  <a class="btn btn-info" href="#"> <i class="glyphicon glyphicon-pencil"></i>  Detalles
                                                                  </a>
                                                              </td>
                                                              <td>
                                                                <a class="btn btn-danger" href="#" ><i class="glyphicon glyphicon-trash"></i>  Eliminar 
                                                                </a>
                                                              </td>
                                                             <?php endif ?>
                                                           <?php if ($id_rol != 1): ?>
                                                              ...
                                                              <td>
                                                                <a class="btn btn-danger" href="#eliminar_rol" data-toggle="modal"><i class="glyphicon glyphicon-trash"></i>  Eliminar 
                                                                </a>
                                                              </td>
                                                            <?php endif; ?>
