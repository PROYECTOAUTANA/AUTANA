            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-12 grupobotones">
                          <p><i class="fa fa-lock"></i> Este trabajo ha sido cerrado de forma automatica porque ha llegado a su fase final y todos los autores del mismo han sido ascendidos...</p>

                          <p> <b> Fecha del cierre : <?php echo $datos_trabajo->trabajo_fecha_de_cierre; ?></p></b></p>
                          <hr>
                        </div>
                    </div>
                     <div class="col-sm-12">
