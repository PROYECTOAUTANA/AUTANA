        ...
        <div id="contenido">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                            <form class="form-group" action="?controller=usuario&action=editar_mis_datos" method="post" data-toggle="validator">
                    ...
                    <div class="modal-dialog">
                      ...
                      <!--CUERPO O BODY DE LA VENTANA-->
                        <div class="modal-body col-sm-12">
                          ...
                          <form class="form-group" action="?controller=usuario&action=cambiar_mi_departamento" method="post" data-toggle="validator">
                          <input type="hidden" name="id_usuario" value="<?php echo $datos_usuario->id_usuario; ?>">
                            <div class="col-sm-12 form-group">
